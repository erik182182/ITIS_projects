...
public class SignInServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        else req.getRequestDispatcher("/WEB-INF/views/signin.ftl").forward(req, res);
    }
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
        ...
        try{
            ...
            req.getRequestDispatcher("/WEB-INF/views/signin.ftl").forward(req,res);
            return;
        }
        ...
        if(((UserDto)req.getSession().getAttribute("user")).getType().equals("user")){
            res.sendRedirect("/home");
        }
        else{
            res.sendRedirect("/adminPage");
